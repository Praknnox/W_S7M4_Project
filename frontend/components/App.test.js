...
describe('Module 4 Project Tests', () => {
  describe('English Language', () => {
    ...
    */
    ...
    test(`LABEL_USERNAME is visible`, () => {
      render(<App lang="en" />)
      expect(screen.getLabelText(txt.en.LABEL_USERNAME)).toBeVisible()
    })
  ...
  describe('Spanish Language', () => {
    ...
    */
      ...
      test(`LABEL_USERNAME is visible`, () => {
        render(<App lang="esp" />)
        expect(screen.getLabelText(txt.esp.LABEL_USERNAME)).toBeVisible()
      })
      test(`PLACEHOLDER_USERNAME is visible`, () => {
        render(<App lang="esp" />)
  ...
  expect(getEntriesByKeyPrefix(obj,'uio')).toEqual([])
    })
  })
})
